...
const mainProcessContent = fs.readFileSync(MAIN_PROCESS_FILE, "utf8");
...
const updatedContent = mainProcessContent
  .replace(
    /-- ============================================================================\s*-- CHUNK LOADER IMPLEMENTATION[\s\S]*?-- ============================================================================\s*-- ENHANCED QUERY HANDLERS/g,
    combinedSpeciesData +
  ...
  .replace(
    /description = "Complete Pokemon species database with all 1082 species and chunked loading"/g,
