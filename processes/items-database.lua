-- ============================================================================
-- Items Database Process - ADP v1.0 Compliant Implementation
-- Pokemon item data queries with embedded data and self-documentation
-- Supports: GetItem, GetItemsByCategory, GetBerryEffect, GetItemEffect
-- AO Process Implementation for PokéRogue with ADP v1.0 Protocol
-- ============================================================================
...
local ao = ao or { send = function(msg) return true end, id = "items-database-adp" }

-- Process metadata for ADP v1.0 compliance
local PROCESS_INFO = {
    name = "Items Database Process",
    version = "1.0.0",
    adpVersion = "1.0",
    description = "Pokemon item data queries with embedded data including berries, held items, and consumables",
    capabilities = {"GetItem", "GetItemsByCategory", "GetBerryEffect", "GetItemEffect", "HealthCheck", "Info"},
    messageSchemas = {
        GetItem = {
            required = {"Action", "Data", "Timestamp"},
            data = {
                optional = {"id", "name"},
                description = "Either 'id' (number) or 'name' (string) must be provided"
            },
            response = {
                type = "object",
                properties = {"id", "n", "cat", "eff", "val", "stack"}
            }
        },
        GetItemsByCategory = {
            required = {"Action", "Data", "Timestamp"},
            data = {
                required = {"category"},
                description = "Category number (0-11) for item type filtering"
            },
            response = {
                type = "array",
                description = "Array of item objects matching the category"
            }
        },
        GetBerryEffect = {
            required = {"Action", "Data", "Timestamp"},
            data = {
                required = {"id"},
                description = "Berry item ID number for effect details"
            },
            response = {
                type = "object",
                properties = {"name", "effect", "natural", "healAmount", "healPercent", "statusCure", "ppRestore", "pinchBerry", "flavor"}
            }
        },
        GetItemEffect = {
            required = {"Action", "Data", "Timestamp"},
            data = {
                required = {"id"},
                description = "Item ID number for comprehensive effect details"
            },
            response = {
                type = "object",
                properties = {"name", "category", "effect", "value", "stackable", "healAmount", "statusCure", "revivePercent"}
            }
        },
        HealthCheck = {
            ...
            response = {
                type = "object",
                properties = {"status", "processId", "itemCount", "berryCount", "categoriesLoaded", "version"}
            }
        },
        Info = {
            required = {"Action", "Timestamp"},
            response = {
                type = "object",
                description = "ADP v1.0 self-documentation metadata"
            }
        }
    },
    performance = {
        targetResponseTime = "sub-100ms",
        rateLimit = "100 queries per minute per address",
        dataSize = "embedded for optimal performance"
    }
}
...
local ITEM = {
    ...
    SAFARI_BALL = 5, NET_BALL = 6, DIVE_BALL = 7, NEST_BALL = 8,
    REPEAT_BALL = 9, TIMER_BALL = 10, LUXURY_BALL = 11, PREMIER_BALL = 12,
    DUSK_BALL = 13, HEAL_BALL = 14, QUICK_BALL = 15, CHERISH_BALL = 16,
    POTION = 17, ANTIDOTE = 18, BURN_HEAL = 19, ICE_HEAL = 20,
    AWAKENING = 21, PARALYZE_HEAL = 22, FULL_RESTORE = 23, MAX_POTION = 24,
    HYPER_POTION = 25, SUPER_POTION = 26, FULL_HEAL = 27, REVIVE = 28,
    MAX_REVIVE = 29, FRESH_WATER = 30, SODA_POP = 31, LEMONADE = 32,
    MOOMOO_MILK = 33, ENERGY_POWDER = 34, ENERGY_ROOT = 35, HEAL_POWDER = 36,
    REVIVAL_HERB = 37, ETHER = 38, MAX_ETHER = 39, ELIXIR = 40,
    MAX_ELIXIR = 41, LAVA_COOKIE = 42, BERRY_JUICE = 43, SACRED_ASH = 44,
    HP_UP = 45, PROTEIN = 46, IRON = 47, CARBOS = 48, CALCIUM = 49,
    RARE_CANDY = 50, PP_UP = 51, ZINC = 52, PP_MAX = 53, OLD_GATEAU = 54,
    GUARD_SPEC = 55, DIRE_HIT = 56, X_ATTACK = 57, X_DEFENSE = 58,
    X_SPEED = 59, X_ACCURACY = 60, X_SP_ATK = 61, X_SP_DEF = 62,
    POKE_DOLL = 63, FLUFFY_TAIL = 64, BLUE_FLUTE = 65, YELLOW_FLUTE = 66,
    RED_FLUTE = 67, BLACK_FLUTE = 68, WHITE_FLUTE = 69, SHOAL_SALT = 70,
    SHOAL_SHELL = 71, RED_SHARD = 72, BLUE_SHARD = 73, YELLOW_SHARD = 74,
    GREEN_SHARD = 75, SUPER_REPEL = 76, MAX_REPEL = 77, ESCAPE_ROPE = 78,
    REPEL = 79, SUN_STONE = 80, MOON_STONE = 81, FIRE_STONE = 82,
    THUNDER_STONE = 83, WATER_STONE = 84, LEAF_STONE = 85, TINY_MUSHROOM = 86,
    BIG_MUSHROOM = 87, PEARL = 88, BIG_PEARL = 89, STARDUST = 90,
    STAR_PIECE = 91, NUGGET = 92, HEART_SCALE = 93, HONEY = 94,
    GROWTH_MULCH = 95, DAMP_MULCH = 96, STABLE_MULCH = 97, GOOEY_MULCH = 98,
    ROOT_FOSSIL = 99, CLAW_FOSSIL = 100, HELIX_FOSSIL = 101, DOME_FOSSIL = 102,
    OLD_AMBER = 103, ARMOR_FOSSIL = 104, SKULL_FOSSIL = 105, RARE_BONE = 106,
    SHINY_STONE = 107, DUSK_STONE = 108, DAWN_STONE = 109, OVAL_STONE = 110,
    ODD_KEYSTONE = 111, GRISEOUS_ORB = 112,
    -- Berries start at 149
    CHERI_BERRY = 149, CHESTO_BERRY = 150, PECHA_BERRY = 151, RAWST_BERRY = 152,
    ASPEAR_BERRY = 153, LEPPA_BERRY = 154, ORAN_BERRY = 155, PERSIM_BERRY = 156,
    LUM_BERRY = 157, SITRUS_BERRY = 158, FIGY_BERRY = 159, WIKI_BERRY = 160,
    MAGO_BERRY = 161, AGUAV_BERRY = 162, IAPAPA_BERRY = 163, RAZZ_BERRY = 164,
    BLUK_BERRY = 165, NANAB_BERRY = 166, WEPEAR_BERRY = 167, PINAP_BERRY = 168,
    POMEG_BERRY = 169, KELPSY_BERRY = 170, QUALOT_BERRY = 171, HONDEW_BERRY = 172,
    GREPA_BERRY = 173, TAMATO_BERRY = 174, CORNN_BERRY = 175, MAGOST_BERRY = 176,
    RABUTA_BERRY = 177, NOMEL_BERRY = 178, SPELON_BERRY = 179, PAMTRE_BERRY = 180,
    WATMEL_BERRY = 181, DURIN_BERRY = 182, BELUE_BERRY = 183, LIECHI_BERRY = 184,
    GANLON_BERRY = 185, SALAC_BERRY = 186, PETAYA_BERRY = 187, APICOT_BERRY = 188,
    LANSAT_BERRY = 189, STARF_BERRY = 190, ENIGMA_BERRY = 191, MICLE_BERRY = 192,
    CUSTAP_BERRY = 193, JABOCA_BERRY = 194, ROWAP_BERRY = 195
}

local ITEM_CATEGORY = {
    POKEBALL = 0, HEALING = 1, STATUS_CURE = 2, REVIVAL = 3,
    STAT_BOOST = 4, EVOLUTION = 5, BERRY = 6, HELD_ITEM = 7,
    KEY_ITEM = 8, BATTLE_ITEM = 9, VALUABLE = 10, FOSSIL = 11
}
...
local function createIndex(dataTable, keyField)
    local index = {}
    for itemId, data in pairs(dataTable) do
        if data[keyField] then
            index[data[keyField]] = data
        end
    end
    return index
end
