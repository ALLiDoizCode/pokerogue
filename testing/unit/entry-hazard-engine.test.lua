-- DEPRECATED: Entry Hazard Engine Unit Tests
...
-- Process file: processes/entry-hazard-engine.lua (DOES NOT EXIST)
--
...
--
-- Action Required:
-- 1. Create the missing process file: processes/entry-hazard-engine.lua
...
print("🧪 Entry Hazard Engine tests skipped - INCORRECT API (Story 20.1)")
print("⚠️  This test file requires:")
print("   1. Process file creation: processes/entry-hazard-engine.lua")
