-- DEPRECATED: Weather System Engine Unit Tests
-- Tests weather state management, turn processing, damage calculation, and type effectiveness
...
-- Process file: processes/weather-system-engine.lua (DOES NOT EXIST)
--
...
--
-- Action Required:
-- 1. Create the missing process file: processes/weather-system-engine.lua
...
print("🧪 Weather System Engine tests skipped - INCORRECT API (Story 20.1)")
print("⚠️  This test file requires:")
print("   1. Process file creation: processes/weather-system-engine.lua")
