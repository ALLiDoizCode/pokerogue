  ...
  completeGameWorkflow: {
    ...
    steps: [
      ...
      },
      {
        ...
        battleConfig: {
          player1: {
            pokemon: [{ species: "Charizard", level: 50, moves: ["Flamethrower", "Dragon Claw"] }],
          },
          player2: {
            pokemon: [{ species: "Blastoise", level: 50, moves: ["Water Gun", "Skull Bash"] }],
          },
        },
        player1Actions: [
...
export const scenarioConfigs = {
  ...
  quick: {
    scenarios: ["basic-process-communication", "error-handling-validation"],
    timeout: 60000,
  ...
  performance: {
    scenarios: ["performance-stress-testing", "complete-game-workflow"],
  ...
  reliability: {
    scenarios: ["error-handling-validation", "process-failure-recovery", "data-synchronization-test"],
