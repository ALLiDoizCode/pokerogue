...
describe('TDD Pre-commit Hook Integration', () => {
  ...
  describe('Basic TDD Enforcement', () => {
    it('should pass when source file has corresponding test', () => {
      // Create source file
      writeFileSync('processes/battle.lua', `
      ...
      writeFileSync('testing/unit/battle.test.lua', `
    ...
    it('should fail when source file lacks test', () => {
      ...
      writeFileSync('processes/stats.lua', `
    ...
    it('should pass when only test files are modified', () => {
      ...
      writeFileSync('testing/unit/existing.test.lua', `
    ...
    it('should exclude files in data directory', () => {
      ...
      writeFileSync('data/pokemon.lua', `
        return {
  ...
  describe('AO Process Handling', () => {
    it('should handle ao-processes directory correctly', () => {
      writeFileSync('ao-processes/token.lua', `
        function transfer(from, to, amount)
          return { success = true }
        end
      `);
      
      writeFileSync('ao-processes/tests/unit/token.test.lua', `
    ...
    it('should skip ao-processes test files themselves', () => {
      writeFileSync('ao-processes/tests/unit/new-test.test.lua', `
  ...
  describe('Integration with Git Workflow', () => {
    it('should work with git add --patch workflow', () => {
      writeFileSync('processes/incremental.lua', `
        -- First function
      ...
      writeFileSync('testing/unit/incremental.test.lua', `
    ...
    it('should work with git stash workflow', () => {
      ...
      writeFileSync('processes/stable.lua', `
        function stable() end
        function new_function() end
      `);
      
      writeFileSync('testing/unit/stable.test.lua', `
  ...
  describe('Configuration and Customization', () => {
    it('should respect custom configuration', () => {
      ...
      writeFileSync('.tdd-config.json', JSON.stringify({
